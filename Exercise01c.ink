...
~ beginning = beginning + 1
{scratched_door==0: ->nice_staff }
{scratched_door>0: ->angry_staff }
->END
...
==nice_staff==
The staff member  working at the desk sees you, and pets you on the head. {not masterkey: As they return to what they were doing, you notice the masterkey in the drawer. You could easily grab it.}
*[Grab key] -> masterkey
+[Go back] -> lobby
